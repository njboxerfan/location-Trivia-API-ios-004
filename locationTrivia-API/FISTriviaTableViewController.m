...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadData) name:@"triviaReload" object:nil];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        FISTrivia *trivia = self.location.trivia[indexPath.row];
        [FISLocationsDataStore deleteTrivia:trivia forLocation:self.location withCompletion:^{
